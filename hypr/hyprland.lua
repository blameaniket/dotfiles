...
hl.on("hyprland.start", function () 
  hl.exec_cmd("swaybg -i ~/Downloads/wallpapers/minimal_wallpaper.png -m fill &")
  hl.exec_cmd("hyprsunset --gamma 50 --temperature 3000 &")
end)
...
hl.bind(mainMod .. " + h", hl.dsp.window.bring_to_top(), { repeating = true })
hl.bind(mainMod .. " + j", hl.dsp.focus({ direction = "down" }), { repeating = true })
hl.bind(mainMod .. " + j", hl.dsp.window.bring_to_top(), { repeating = true })
hl.bind(mainMod .. " + k", hl.dsp.focus({ direction = "up" }), { repeating = true })
hl.bind(mainMod .. " + k", hl.dsp.window.bring_to_top(), { repeating = true })
hl.bind(mainMod .. " + l", hl.dsp.focus({ direction = "right" }), { repeating = true })
hl.bind(mainMod .. " + l", hl.dsp.window.bring_to_top(), { repeating = true })

hl.bind(mainMod .. " + SHIFT + h", hl.dsp.window.move({ x = -40, y = 0, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + l", hl.dsp.window.move({ x = 40, y = 0, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + k", hl.dsp.window.move({ x = 0, y = -40, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + j", hl.dsp.window.move({ x = 0, y = 40, relative = true }), { repeating = true })

hl.bind("ALT + SHIFT + h", hl.dsp.window.swap({ direction = "left" }), { repeating = true })
hl.bind("ALT + SHIFT + j", hl.dsp.window.swap({ direction = "down" }), { repeating = true })
hl.bind("ALT + SHIFT + k", hl.dsp.window.swap({ direction = "up" }), { repeating = true })
hl.bind("ALT + SHIFT + l", hl.dsp.window.swap({ direction = "right" }), { repeating = true })
